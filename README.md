...
- Designed async job orchestration platform supporting **1000+ concurrent jobs** with
  distributed locking and exactly-once semantics; adopted by **8 teams** as default
- Built **National DQC framework** reconciling data across **7 systems** using graph-based
...
- **Protected $10M+ customer contract** by rebuilding **7 corrupted pipelines** and
  reprocessing **10TB+ data** under a 28-day deadline
- Resurrected **3-year-dead CI/CD** (Docker → Kaniko, Java 8 → 17), restoring security
